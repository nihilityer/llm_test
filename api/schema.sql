...
CREATE UNIQUE INDEX IF NOT EXISTS idx_oauth_uniq ON submissions(user_id, website_id) WHERE submitter_type = 'oauth';
CREATE UNIQUE INDEX IF NOT EXISTS idx_anon_uniq ON submissions(ip_hash, website_id) WHERE submitter_type = 'anonymous';
